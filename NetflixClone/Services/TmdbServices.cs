...
{
    const string ApiKey = "3e4dd84de6af428f1ed0729b5dd49553";
    ...
    HttpClient httpClient => _httpClientFactory.CreateClient(TmdbHttpClientName);
    ...
    public async Task<IEnumerable<Media>> GetAiringTodayAsync() =>
        await GetMediasAsync(TmdbUrls.AiringToday);
    public async Task<IEnumerable<Media>> GetTvPopularAsync() =>
        await GetMediasAsync(TmdbUrls.TvPopular);
    public async Task<IEnumerable<Media>> GetTvTopRatedAsync() =>
        await GetMediasAsync(TmdbUrls.TvTopRated);
    public async Task<IEnumerable<Media>> GetNowPlayingAsync() =>
        await GetMediasAsync(TmdbUrls.NowPlaying);
    public async Task<IEnumerable<Media>> GetSapChieuAsync() =>
        await GetMediasAsync(TmdbUrls.SapChieu);
...
{
    public const string Trending = "3/trending/all/week?language=vi-EN";

    public const string NetflixOriginals = "3/discover/tv?language=vi-EN&with_networks=213";

    public const string TopRated = "3/movie/top_rated?language=vi-EN";

    public const string Action = "3/discover/movie?language=vi-EN&with_genres=28";

    public const string MovieGenres = "3/genre/movie/list?language=vi-EN";

    public const string UpComing = "3/movie/upcoming?language=vi-EN";
