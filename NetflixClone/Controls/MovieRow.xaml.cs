...
public partial class MovieRow : ContentView
{
    ...
    {
        get => (string)GetValue(HeadingProperty); set => SetValue(HeadingProperty, value);
    }
    public IEnumerable<Media> Movies
    {
        get => (IEnumerable<Media>)GetValue(MoviesProperty); set => SetValue(MoviesProperty, value);
    }
    public bool IsLarge
    {
        get => (bool)GetValue(IsLargeProperty); set => SetValue(IsLargeProperty, value);
    }
